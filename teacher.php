...
<body id="body-pd" style="">
	...
	<div class="container-fluid">
		<div class="jumbotron">
			<h1 class="display-5">Capture Attendance</h1>
			<hr class="my-4 mt-0">
			<br>
			<form>
				<div class="row" style="padding: 5px;">
					<div class="col-md-6 col-lg-3 .mx-auto text-center" style="padding: 12px">
                        ...
                        <select id="department" class="form-control" onchange="choose()">
                    ...
                    <div class="col-md-6 col-lg-3 .mx-auto text-center" style="padding: 12px">
                        ...
                        <select id="class" class="form-control" onchange="choose2()">
				...
				<div class="row" style="padding: 12px; margin: 5px">
					...
					<div class="col-md-4 .mx-auto text-center">
						<button type="button" id="record_attendance_button" class="btn btn-success form-control" onclick="record_attendance()">Record Attendance</button>
                        <script type="text/javascript">
                            function record_attendance() {
                                ...
                                if (department && classes && shift && subject) {
                                    document.getElementById('record_attendance_button').style.visibility = "hidden";

                                    $.ajax({
                                        type: "POST",
                                        url: "Python/call_python_from_php.php",
                                        data: { 
                                    ...
                                    var timeleft = 30;
                                    var attendanceTimer = setInterval(function(){
                                      if(timeleft <= 0){
                                        popup.innerHTML = '<a href="view-subject.php?department='+department+'&class='+classes+'&shift='+shift+'&subject='+subject+'">Click here to view attendance</a>';
                                        clearInterval(attendanceTimer);
                                      }
                                      sec.innerHTML = timeleft - 1;
                                      timeleft -= 1;
                                    }, 1000);
                                }
                                else{
                ...
                <div class="popup" id="popup">
                    Recording attendance. Please wait for <b id="sec">20</b> sec.
                </div>
			</form>
			<br>
			<h5 class="text-center">To Record the Attendance Select the Department Class & Shift of your class and press Record Attendance</h5>
			<br>
		</div>
	</div>
